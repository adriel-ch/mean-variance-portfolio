...
# pre_url = "https://www.huobi.com/vision/?prefix=data/klines/future/daily/BTC230526/60min/"


# def b_download_daily_spot(data_type: str, start: datetime, end: datetime, all_period: list = [], all_symbols: list = []):
...
def b_download_daily_future(data_type: str, start: datetime, end: datetime, all_period: list = [], all_symbols: list = []):
    '''return date is: [start, end)'''
...
# def b_download_daily_swap(data_type: str, start: datetime , end: datetime, all_period: list = [], all_symbols: list = []):
#     '''return date is: [start, end)'''
...
# def b_download_daily_linearswap(data_type: str, start: datetime, end: datetime, all_period: list = [], all_symbols: list = []):
#     '''return date is: [start, end)'''
...
# def b_download_daily_option(data_type: str, start: datetime, end: datetime, all_period: list = [], all_symbols: list = []):
#     '''return date is: [start, end)'''
